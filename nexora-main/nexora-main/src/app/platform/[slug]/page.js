...
export default function PlatformPage({ params }) {
    ...
    const data = PLATFORM_DATA[slug] || {
        ...
        desc: 'Explore the robust platform capabilities designed to scale your healthcare operations seamlessly.',
        icon: Layers,
        stats: [],
        features: [],
        workflow: []
                    ...
                    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                        <div style={{ textAlign: 'center', marginBottom: '64px' }}>
                            ...
                            <p style={{ fontSize: '18px', color: '#64748B', maxWidth: '600px', margin: '0 auto' }}>
                                Architectural brilliance driving performance at scale.
                            </p>
                        </div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1.5fr)', gap: '64px', alignItems: 'start' }}>
                            <div style={{ position: 'sticky', top: '100px' }}>
                                ...
                                <p style={{ fontSize: '18px', color: '#64748B', lineHeight: 1.6, marginBottom: '32px' }}>
                                    How this core module connects, scales, and operates securely in the background.
                                </p>
                            </div>
                ...
                <section style={{ padding: '100px 24px', background: '#071220' }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                        ...
                        <Link href="/request-demo" style={{
                            ...
                            Talk to an Architect <ArrowRight size={18} strokeWidth={2.5} />
                        </Link>
                    </div>
                </section>
