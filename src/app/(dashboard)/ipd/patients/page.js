                                        ...
                                        <td style={{ padding: '16px', textAlign: 'right' }}>
                                            <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                                                {row.status !== 'Discharged' ? (
                                                    <Link href={`/ipd/patients/${row.id}/discharge`} className="btn btn-secondary btn-sm" style={{ padding: '6px 12px', fontSize: '11px', color: '#10B981', borderColor: '#10B981', textDecoration: 'none' }}>
                                                        <FileText size={12} style={{ marginRight: '4px', display: 'inline' }} /> Discharge & Bill
                                                    </Link>
                                                ) : (
                                                    <span className="badge badge-green" style={{ fontSize: '11px', padding: '4px 8px' }}>Discharged</span>
                                                )}
