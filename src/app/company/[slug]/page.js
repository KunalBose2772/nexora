...
export default function CompanyPage({ params }) {
    ...
    const data = COMPANY_DATA[slug] || {
        ...
        desc: 'Discover more about our company, vision, and the incredible team driving the future of healthcare software.',
        icon: Building2,
        stats: [],
        features: [],
        workflow: []
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.5fr) minmax(0, 1fr)', gap: '64px', alignItems: 'center' }}>
                            <div>
                                ...
                                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                                    {slug === 'careers' ? (
                                        <Link href="mailto:careers@nexorahealth.com" style={{
                                            display: 'inline-flex', alignItems: 'center', gap: '8px',
                    ...
                    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                        <div style={{ textAlign: 'center', marginBottom: '64px' }}>
                            ...
                            <p style={{ fontSize: '18px', color: '#64748B', maxWidth: '600px', margin: '0 auto' }}>
                                The beliefs and philosophies driving everything we do.
                            </p>
                        </div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1.5fr)', gap: '64px', alignItems: 'start' }}>
                            <div style={{ position: 'sticky', top: '100px' }}>
                                ...
                                <p style={{ fontSize: '18px', color: '#64748B', lineHeight: 1.6, marginBottom: '32px' }}>
                                    A timeline of our ongoing mission to overhaul clinical administration.
                                </p>
                            </div>
                                ...
                                {data.workflow?.map((step, i) => (
                                    <div key={i} style={{
                                        ...
                                        <div style={{
                                            ...
                                            fontSize: '11px', fontWeight: 700, flexShrink: 0, zIndex: 1
                                        }}>
                                            {step.step}
                                        </div>
                ...
                <section style={{ padding: '100px 24px', background: '#071220' }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                        <h2 style={{ fontSize: '42px', fontWeight: 800, color: '#FFFFFF', letterSpacing: '-0.02em', marginBottom: '24px' }}>
                            {slug === 'careers' ? "Join our clinical mission." : "Partner with excellence."}
                        </h2>
                        {slug === 'careers' ? (
                            <Link href="mailto:careers@nexorahealth.com" style={{
                                display: 'inline-flex', alignItems: 'center', gap: '8px',
                                ...
                                Open Positions <ArrowRight size={18} strokeWidth={2.5} />
                            </Link>
                        ) : (
                            <Link href="/request-demo" style={{
                                display: 'inline-flex', alignItems: 'center', gap: '8px',
                                ...
                                Contact the Team <ArrowRight size={18} strokeWidth={2.5} />
                            </Link>
                        )}
                    </div>
                </section>
