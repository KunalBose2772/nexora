                ...
                <div className="login-right">
                    <div style={{ width: '100%', maxWidth: '400px' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '32px' }}>
                            <Image src="/nexora-mark.svg" alt="Nexora Health" width={26} height={26} />
                        ...
                        <form aria-label="Sign in form" noValidate onSubmit={async (e) => {
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
                                ...
                                <Link href="/forgot-password" style={{ fontSize: '13px', color: '#00C2FF', textDecoration: 'none', fontWeight: 500 }}>
                                    Forgot password?
                                </Link>
                            </div>
