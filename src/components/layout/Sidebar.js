...
const NAV_GROUPS = [
    ...
    },
    {
        ...
        items: [
            ...
            { href: '/icu', icon: Activity, label: 'ICU Central' },
            { href: '/patients', icon: Users, label: 'Patients' },
            { href: '/appointments', icon: CalendarDays, label: 'Appointments' },
            { href: '/opd', icon: Stethoscope, label: 'OPD' },
            { href: '/ipd', icon: BedDouble, label: 'IPD / Wards' },
            { href: '/ot', icon: Scissors, label: 'OT Schedule' },
            { href: '/blood-bank', icon: Droplets, label: 'Blood Bank' },
            { href: '/maternity', icon: Heart, label: 'Maternity & Labor' },
        ],
    },
    {
        label: 'Services',
        items: [
            ...
            { href: '/radiology', icon: LucideImage, label: 'Radiology' },
            { href: '/pharmacy', icon: Pill, label: 'Pharmacy' },
            { href: '/inventory', icon: Package, label: 'Inventory & Stores' },
        ],
    },
    {
        label: 'Patient Relations',
        items: [
            { href: '/communications', icon: MessageSquare, label: 'Engagement Hub' },
            { href: '/grievances', icon: HeartHandshake, label: 'Grievance / Feedback' },
        ],
    },
    {
        label: 'Finance',
        items: [
            ...
            { href: '/insurance', icon: ShieldCheck, label: 'Insurance & TPA' },
        ],
    },
    {
